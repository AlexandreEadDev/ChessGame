...
export const initialBoard = new ChessBoard(
  [
    ...
    // **CORRECTION** : Ajout du type "PAWN" lors de la création des pions.
    new Pawn(new Position(0, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(1, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(2, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(3, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(4, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(5, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(6, 6), "PAWN", "BLACK", false),
    new Pawn(new Position(7, 6), "PAWN", "BLACK", false),
    ...
    // **CORRECTION** : Ajout du type "PAWN" lors de la création des pions.
    new Pawn(new Position(0, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(1, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(2, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(3, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(4, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(5, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(6, 1), "PAWN", "WHITE", false),
    new Pawn(new Position(7, 1), "PAWN", "WHITE", false),
  ],
  1
);
