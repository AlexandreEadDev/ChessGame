...
export const initialPieceState = [
  ...
  new Piece(new Position(0, 6), "PAWN", "BLACK"),
  new Piece(new Position(1, 6), "PAWN", "BLACK"),
  new Piece(new Position(2, 6), "PAWN", "BLACK"),
  new Piece(new Position(3, 6), "PAWN", "BLACK"),
  new Piece(new Position(4, 6), "PAWN", "BLACK"),
  new Piece(new Position(5, 6), "PAWN", "BLACK"),
  new Piece(new Position(6, 6), "PAWN", "BLACK"),
  new Piece(new Position(7, 6), "PAWN", "BLACK"),
  ...
  new Piece(new Position(0, 1), "PAWN", "WHITE"),
  new Piece(new Position(1, 1), "PAWN", "WHITE"),
  new Piece(new Position(2, 1), "PAWN", "WHITE"),
  new Piece(new Position(3, 1), "PAWN", "WHITE"),
  new Piece(new Position(4, 1), "PAWN", "WHITE"),
  new Piece(new Position(5, 1), "PAWN", "WHITE"),
  new Piece(new Position(6, 1), "PAWN", "WHITE"),
  new Piece(new Position(7, 1), "PAWN", "WHITE"),
];
